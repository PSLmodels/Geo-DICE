function [S2, C2]  =  NextState( S1, a1, g1, t1, W1, JJ )
...
%%New specification
Damage = (1 - dm)/((1 + sai2temp * (W1 * S1(2)) ^ 2 + sai2ocean * (S1(5) - 1094) ^ 2 + sai2atmos * (S1(4) - 596.4) ^ 2) * (1 + nuG * g1 ^ 2));
Dam = 1 - Damage;
